...
const allProjects = [
  { title: "NuSummit Brand Revamp", description: "Short film exploring the tactile nature of ceramic arts", category: "Brand videos", videoSrc: "/videos/clay.mp4", imageSrc: "https://youtu.be/8-zs1MUfrnE?si=OX6xGgJZt0VYedke" },
