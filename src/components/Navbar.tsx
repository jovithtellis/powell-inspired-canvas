  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-4 px-4 md:px-8 ${
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <a 
          href="#" 
          className="text-xl font-medium hover:text-gray-700 dark:hover:text-gray-300 transition-colors text-foreground" 
          onClick={e => {
            e.preventDefault();
            window.scrollTo({
              top: 0,
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button 
            variant="ghost" 
            size="sm" 
            className="md:hidden text-foreground premium-button" 
